...
- After the category breakdown, add a *🔄 Close the Loop* section ONLY if any items have Status "Actioned". One bullet per such item: "✅ [Title] — Actioned". Omit this section entirely if no items have that status.
