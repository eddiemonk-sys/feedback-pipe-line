...
5. **Date/timeline preservation:** does every specific date or timeline in the original message appear verbatim as a bullet in the summary? If the source message contains no dates or timelines, this check is automatically satisfied.
